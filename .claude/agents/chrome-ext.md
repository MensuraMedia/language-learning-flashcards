...
# Chrome Extension Specialist (Sonnet) — Japanese Practice
...
- **Project**: Japanese Practice
- **Path**: /home/user/projects/japanese_practice
- **Description**: Local desktop flash-card app for Hiragana, Katakana and Kanji (Quart + pywebview)
- **Date**: 2026-08-06
